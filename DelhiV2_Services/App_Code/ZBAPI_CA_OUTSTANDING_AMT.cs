...
/// <summary>
/// Summary description for ZBAPI_CA_OUTSTANDING_AMT
/// </summary>
public class ZBAPI_CA_OUTSTANDING_AMT
{
	public ZBAPI_CA_OUTSTANDING_AMT()
	{
		//
    ...
    public void pushOutputDataInDataTable(DataTable dt, string _sO_VKONT, string _sO_FLAG, string _sO_MSG)
    {
        DataRow dr = dt.NewRow();
        dr["E_O_VKONT"] = _sO_VKONT;
    ...
    public DataTable makeFlagsTable()
    {
        ...
        DataColumn dtCol1 = new DataColumn("E_O_VKONT", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol1);
        DataColumn dtCol2 = new DataColumn("E_O_FLAG", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol2);
        DataColumn dtCol3 = new DataColumn("E_O_MSG", System.Type.GetType("System.String"));
