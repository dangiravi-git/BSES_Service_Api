...
/// <summary>
/// Summary description for ZBAPI_FETCH_ENF_USER_DET
/// </summary>
public class ZBAPI_FETCH_ENF_USER_DET
{
    public ZBAPI_FETCH_ENF_USER_DET()
    {
        //
    ...
    public void pushOutputDataInDataTable(DataTable dt, string CASE_ID, string COMPLAINT_ID, string INSPECTION_DATE, string INSP_CA_NUMBER,
                                         string USER_NAME, string HOUSEFLATNO, string BUILDING_NAME1, string STREET1, string COLONY_AREA1,
                                         string LANDMARK, string CITY_CODE1, string PIN_CODE1, string CASE_TYPE, string ENF_ORDER, string SOURCE_OF_COMPLA,
                                         string COKEY, string SUB_DIV)
    {
        DataRow dr = dt.NewRow();
        dr["E_O_CASE_ID"] = CASE_ID;
        dr["E_O_COMPLAINT_ID"] = COMPLAINT_ID;
        dr["E_O_INSPECTION_DATE"] = INSPECTION_DATE;
        dr["E_O_INSP_CA_NUMBER"] = INSP_CA_NUMBER;
        dr["E_O_USER_NAME"] = USER_NAME;
        dr["E_O_HOUSEFLATNO"] = HOUSEFLATNO;
        dr["E_O_BUILDING_NAME1"] = BUILDING_NAME1;
        dr["E_O_STREET1"] = STREET1;
        dr["E_O_COLONY_AREA1"] = COLONY_AREA1;
        dr["E_O_LANDMARK"] = LANDMARK;
        dr["E_O_CITY_CODE1"] = CITY_CODE1;
        dr["E_O_PIN_CODE1"] = PIN_CODE1;
        dr["E_O_CASE_TYPE"] = CASE_TYPE;
        dr["E_O_ENF_ORDER"] = ENF_ORDER;
        dr["E_O_SOURCE_OF_COMPLA"] = SOURCE_OF_COMPLA;
        dr["E_O_COKEY"] = COKEY;
        dr["E_O_SUB_DIV"] = SUB_DIV;
        dt.Rows.Add(dr);
    }
    ...
    public DataTable makeFlagsTable()
    {
        ...
        DataColumn dtCol1 = new DataColumn("E_O_CASE_ID", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol1);
        DataColumn dtCol2 = new DataColumn("E_O_COMPLAINT_ID", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol2);
        DataColumn dtCol3 = new DataColumn("E_O_INSPECTION_DATE", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol3);
        DataColumn dtCol4 = new DataColumn("E_O_INSP_CA_NUMBER", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol4);
        DataColumn dtCol5 = new DataColumn("E_O_USER_NAME", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol5);
        DataColumn dtCol6 = new DataColumn("E_O_HOUSEFLATNO", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol6);
        DataColumn dtCol7 = new DataColumn("E_O_BUILDING_NAME1", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol7);
        DataColumn dtCol8 = new DataColumn("E_O_STREET1", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol8);
        DataColumn dtCol9 = new DataColumn("E_O_COLONY_AREA1", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol9);
        DataColumn dtCol10 = new DataColumn("E_O_LANDMARK", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol10);
        DataColumn dtCol11 = new DataColumn("E_O_CITY_CODE1", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol11);
        DataColumn dtCol12 = new DataColumn("E_O_PIN_CODE1", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol12);
        DataColumn dtCol13 = new DataColumn("E_O_CASE_TYPE", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol13);
        DataColumn dtCol14 = new DataColumn("E_O_ENF_ORDER", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol14);
        DataColumn dtCol15 = new DataColumn("E_O_SOURCE_OF_COMPLA", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol15);
        DataColumn dtCol16 = new DataColumn("E_O_COKEY", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol16);
        DataColumn dtCol17 = new DataColumn("E_O_SUB_DIV", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol17);
        return dtFlags;
    }
}