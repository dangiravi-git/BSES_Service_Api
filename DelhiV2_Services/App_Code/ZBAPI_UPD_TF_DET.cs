...
/// <summary>
/// Summary description for ZBAPI_UPD_TF_DET
/// </summary>
public class ZBAPI_UPD_TF_DET
{
    public ZBAPI_UPD_TF_DET()
    {
        //
    ...
    public DataTable makeFlagsTable()
    {
        ...
        DataColumn dtCol0 = new DataColumn("RETURN", System.Type.GetType("System.String"));
