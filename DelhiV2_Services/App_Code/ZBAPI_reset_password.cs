...
class ZBAPI_reset_password
{
    public DataTable makeTable()
    {
        DataTable dtFlags = new DataTable("outputFlagsTable");
        DataRow dr = dtFlags.NewRow();
        DataColumn dtCol1 = new DataColumn("LOCK_MSG", System.Type.GetType("System.String"));
        dtFlags.Columns.Add(dtCol1);
        DataColumn dtCol2 = new DataColumn("MESSAGE", System.Type.GetType("System.String"));
    ...
    public void pushOutputDataInDataTable(DataTable dt, string _LOCK_MSG, string _MESSAGE)
    {
        DataRow dr = dt.NewRow();
