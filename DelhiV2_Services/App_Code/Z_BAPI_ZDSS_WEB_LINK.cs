...
/// <summary>
/// Summary description for Z_BAPI_ZDSS_WEB_LINK
/// </summary>
public class Z_BAPI_ZDSS_WEB_LINK
{
    ...
    public class I_DSSORDER
    {
        public string ABKRS;
        public string APPLIEDCAT;
        public string APPLIEDLOAD;
        public string APPLIEDLOADKVA;
        ...
        public string STATEMENT_CA;
        public string SYSTEMCOND;
        public string WORKCENTRE;        
    }

    public class I_BUSINESSPARTNER_ECC
    {
